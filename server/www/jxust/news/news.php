...
<div class="centent">
	<ul class="newsCent">
		<li>
			<p class="text"><a href="new_centent.php?i=1&page=<?php echo $p;?>"><?php echo $j_news_top1; ?></a></p>
			<span>发布者：团委宣传部</span>
		...
		<li>
			<p class="text"><a href="new_centent.php?i=2&page=<?php echo $p;?>"><?php echo $j_news_top2; ?></a></p>
			<span>发布者：团委宣传部</span>
			<span class="time" style="color: red">
			<?php 
				if($p==1){
		...
		<li>
			<p class="text"><a href="new_centent.php?i=<?php print($i+1); ?>&page=<?php echo $p; ?>"><?php echo $j_news_all[$i]; ?></a></p>
			<span>发布者：团委宣传部</span>
...
<ul class="page">
	...
	<li><a href="news.php?page=<?php if($p>1){print($p-1);}else{print(1);} ?>">上一页</a></li>
	<li><a href="news.php?page=<?php print($p+1); ?>">下一页</a></li>
