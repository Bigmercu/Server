...
<div class="centent">
	<ul class="newsCent">
		<li>
			<p class="text"><a href="xueshu_centent.php?i=1&page=<?php echo $p;?>"><?php echo $j_news_top1; ?></a></p>
			<span>发布者：团委宣传部</span>
		...
		<li>
			<p class="text"><a href="xueshu_centent.php?i=2&page=<?php echo $p;?>"><?php echo $j_news_top2; ?></a></p>
			<span>发布者：学术公告管理员</span>
			<span class="time" style="color: red">
			<?php 
				if($p==1){
					echo "最新";
		...
		<li>
			<p class="text"><a href="xueshu_centent.php?i=<?php print($i+1); ?>&page=<?php echo $p; ?>"><?php echo $j_news_all[$i]; ?></a></p>
			<span>发布者：学术公告管理员</span>
...
<!--分页-->
<ul class="page">
	<li><a href="xueshu.php?page=1">首页</a></li>
	<li><a href="xueshu.php?page=<?php if($p>1){print($p-1);}else{print(1);} ?>">上一页</a></li>
	<li><a href="xueshu.php?page=<?php print($p+1); ?>">下一页</a></li>
