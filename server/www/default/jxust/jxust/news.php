...
<div id="centent">
	<ul class="newsCent">
		<li>
			<p class="text"><a href="<?php echo $out_a[1][0]; ?>"><?php echo $j_news_top1; ?></a></p>
			<span>发布者：团委宣传部</span>
			<span class="time" style="color: red">热点新闻</span>
		</li>
		<li>
			<p class="text"><a href="<?php echo $out_a[1][1]; ?>"><?php echo $j_news_top2; ?></a></p>
			<span>发布者：团委宣传部</span>
			<span class="time" style="color: red">热点新闻</span>
		</li>
		<?php for($i=2;$i<=count($j_news_all)-2;$i++){ ?>
		<li>
			<p class="text"><a href="<?php echo $out_a[1][$i] ?>"><?php echo $j_news_all[$i]; ?></a></p>
			<span>发布者：团委宣传部</span>
...
<div class="top_bar" style="-webkit-transform:translate3d(0,0,0)">
  <nav>
    <ul id="top_menu" class="top_menu">
        <li> <a href="/?wecha_id="><img src="images/iconfont-xiaoyuan.png" width="30"><label>理工新闻</label></a></li>
        <li> <a href="javascript:void(0)"><img src="images/iconfont-xinwen.png" width="30"><label>校园传真</label></a></li>
		<li> <a href="tel:13888888888"><img src="images/iconfont-meitibaodao.png" width="30"><label>媒体聚焦</label></a></li>
        <li> <a href="javascript:void(0)"><img src="images/iconfont-xinshouxuetang.png" width="30"><label>学术公告</label></a></li>  
    </ul>
  </nav>
</div>
